...
export class IncidentFormService {
    ...
    impactChoices: any;
    purposeChoices: any;
    incidentInvolvementChoices: any;
    conditionChoices: any;
    sightConditionsChoices: any;
    carsParkedChoices: any;
    ridingOnChoices: any;
    lightChoices: any;
    terrainChoices: any;
    directionChoices: any;
    turningChoices: any;
    helmetChoices: any;
    intoxicatedChoices: any;
    sourceChoices: any;
    bicycleTypeChoices: any;
    eBikeChoices: any;
